...
namespace NSSInvoiceApp.Data
{
    public class DataService
    {
        ...
        public async Task SendEmail(string subject, string body, int invoiceId)
        {
            try
            {
        ...
        public static void ConvertInvoiceToPDF(Invoice invoice, List<InvoiceItem> invoiceItems, Customer customer)
        {
            using (ExcelEngine excelEngine = new ExcelEngine())
            {
                ...
                Stream inputStream = executingAssembly.GetManifestResourceStream("Template.xlsx");
